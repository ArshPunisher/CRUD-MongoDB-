              ...
              <tr key={idx}>
                ...
                <td>
                  <div className='d-flex justify-content-end gap-2'>
                    <NavLink className="btn btn-primary btn-small" type="button" to={'/view/'+customer._id}>
                      <i className='bi bi-eye'></i>
                    </NavLink>
                    <NavLink className="btn btn-warning btn-small" type="button" to={'/edit/'+customer._id}>
                      <i className='bi bi-pencil'></i>
                    </NavLink>
                    <button type="submit" onClick={()=> handleDelete(customer._id)} className='btn btn-danger btn-small'>
