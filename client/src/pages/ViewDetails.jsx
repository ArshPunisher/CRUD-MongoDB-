...
<div class="d-flex justify-content-between flex-wrap flex-md nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">{details.firstname} { details.lastname }</h1>
      ...
      <div class="col py-3">
        <div class="row">
          ...
          <div class="col text-end fw-lighter">
            <b>Last Updated: {new Date(details.updatedAt).toUTCString()}</b>
          </div>
        </div>
      </div>
      ...
      <ul className="list-group">
        ...
        <li className="list-group-item">
          <div className="row">
            ...
            <div className="col">{details.createdAt}</div>
          </div>
        </li>
        ...
        <li className="list-group-item">
          <div className="row">
            ...
            <div className="col">{details.updatedAt}</div>
          </div>
        </li>
      </ul>
    </div>
